            ...
            <div class="card bg-base-100 shadow-sm">
                ...
                <div class="p-6 md:p-4 ">
                    ...
                    <div class="card-actions justify-between">
                        <button id="likeCard${pet.petId}" onclick="like(${pet.petId})" class="btn bg-white mt-2 md:px-4 px-6 py-2 rounded-lg">
...
loadCategories();
loadPetCards();
// <img src="images/icons/Frame (4).svg" alt="icon" class="w-6 h-6">