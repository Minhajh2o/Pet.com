            ...
            <div class="card bg-base-100 shadow-sm">
                ...
                <div class="p-6 md:p-4 ">
                    ...
                    <div class="card-actions justify-between">
                        <button id="likeCard${pet.petId}" class="likeBtn btn bg-white mt-3 md:px-4 px-6 py-2 rounded-lg">
                                <svg id="likeIcon${pet.petId}" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <button class="btn primary-color bg-white mt-3 px-6 md:px-4 lg:px-5 py-2 rounded-lg">Adopt</button>
                        <button onclick="loadPetDetails(${pet.petId})" class="btn primary-color bg-white mt-3 px-6 md:px-4 lg:px-5 py-2 rounded-lg">Details</button>
                    </div>
                </div>
            </div>
        `;
